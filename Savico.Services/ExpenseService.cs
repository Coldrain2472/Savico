namespace Savico.Services
{
    ...
    public class ExpenseService : IExpenseService
    {
        ...
        public async Task<ExpenseInputViewModel> PrepareExpenseInputModelAsync(ExpenseInputViewModel inputModel)
        {
        ...
        .FirstOrDefaultAsync(e => e.Id == expenseId && e.UserId == userId);
            ...
            {
                throw new UnauthorizedAccessException("Expense not found or you do not have permission to edit it.");
            }
        }
